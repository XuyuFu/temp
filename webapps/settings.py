...
SECRET_KEY = '&8oslzynhb&qlb%*3*(md_8tpxzep6yu5xv^f-^dv()i_#ahb+'
...
config = ConfigParser()
config.read(os.path.join(BASE_DIR, 'config.payfun.sample'))
...
print('Email host:port = {host}:{port}, user={user}'.format(host=EMAIL_HOST, 
    port=EMAIL_PORT, user=EMAIL_HOST_USER))
